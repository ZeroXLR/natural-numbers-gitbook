...
&nbsp;
> The next simple lemma is used a few times in the main result of this section. Hence, it is worth spelling it out completely instead of proving it every time that it is needed.
